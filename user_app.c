...
{
/*ENABLE TIMER0 IN 16-BIT WITH POST-SCALAR 1:1*/
	T0CON0 = 0x90;
    
/*SET TIMER0 ASYNC WITH FOSC/4 AS SOURCE AND PRE-SCALAR 1:16*/
    T0CON1 = 0x54;
...
void UserAppRun(void)
{
    ...
    /*U8ARRAYINDEX RETURNS TO 0 IN CASE OF OVERFLOW */
...
void TimeXus(u16 u16TimerTime)
{
	...
	/*RIGHT SHIFT THE UPPER 8 BITS OF U16TIMERTIME TO FIT TMR0H*/ 
    /*TMR0H BECOMES 8 MSB OF U16TIMERTIME*/ 
	TMR0H = (0xFFFF - u16TimerTime) >> 8; 
    
    /*PRELOAD TMR0L/H FROM PASSED U16TIMERTIME  VALUES */
	/*TAKE THE LOWEST 8 BITS of U16TIMERTIME FOR TMR0L*/ 
	/*TMR0L BECOMES 8 LSB OF U16TIMERTIME*/ 
